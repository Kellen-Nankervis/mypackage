...
multiply(4, 6) # Multiplies two numbers and gives the output
divide(10, 2) # Takes the first number and divides it by the second. Will return an error if dividing by 0.
